...
product (type, price, import) tax (type, rate) cart (product, quantity) receipt (cart, )
...
Run the program with: java SalesTax /<testfilename> exemptions.txt Note: 3 files from the problem have been included for your convenience.
...
Items to be excluded from the goods sales tax (10%) is included in a text file called exemptions.txt.
